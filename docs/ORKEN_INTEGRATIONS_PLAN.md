...
**Variáveis de ambiente:**
```env
Integrations__Features__StripeEnabled=true
Integrations__Stripe__SecretKey=sk_test_...
Integrations__Stripe__WebhookSecret=whsec_...
Integrations__Stripe__PriceIds__restaurante_monthly=price_...
Integrations__Stripe__PriceIds__restaurante_annual=price_...
Integrations__Stripe__PriceIds__build_monthly=price_...
Integrations__Stripe__PriceIds__build_annual=price_...
```

**Nota:** chave do PriceIds usa underscore (`restaurante_monthly`) — não usar dois-pontos, que é separador de path no sistema de config .NET e quebra env vars no Railway.
...
Integrations__Stripe__SecretKey=sk_test_...
Integrations__Stripe__WebhookSecret=whsec_...
# PriceIds: chave = {moduleKey}_{billingPeriod} (underscore — não usar dois-pontos)
Integrations__Stripe__PriceIds__restaurante_monthly=price_...
Integrations__Stripe__PriceIds__restaurante_annual=price_...
Integrations__Stripe__PriceIds__build_monthly=price_...
Integrations__Stripe__PriceIds__build_annual=price_...
