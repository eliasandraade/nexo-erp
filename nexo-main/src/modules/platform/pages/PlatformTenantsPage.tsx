...
import { Building2, Store, Users, ChevronRight, Search } from "lucide-react";
    ...
    <div className="p-6 space-y-4">
      ...
      <div className="relative max-w-sm">
        ...
        <input
          ...
          className="w-full h-9 pl-9 pr-3 rounded-lg bg-muted border-none text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-secondary/30"
        />
      </div>
