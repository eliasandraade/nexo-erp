...
export function SupplierMainDataSection({ data, onChange, isEdit = false }: Props) {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
      ...
      <div className="space-y-1.5 md:col-span-2">
        ...
        <Input
          ...
          placeholder={isCompany ? "Razão social da empresa" : "Nome completo do fornecedor"}
        />
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <div className="flex gap-2">
          <Input
            ...
            placeholder={data.documentType === "CPF" ? "000.000.000-00" : data.documentType === "CNPJ" ? "00.000.000/0001-00" : ""}
            disabled={isEdit}
            className="flex-1"
          />
